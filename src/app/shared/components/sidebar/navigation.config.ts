...
export const NAV_ITEMS: NavItem[] = [
  ...
  // ─── Dashboard ────────────────────────────────────────────────────────────
  {
    ...
    modulos: [MODULO.DASHBOARD], exactMatch: true,
  },
  ...
  {
    label: 'Mi Tutoría', icon: 'school', route: '/mi-tutoria',
  ...
  // ═══ ADMIN ════════════════════════════════════════════════════════════════
  {
    ...
    dividerBefore: true,
    children: [
      { label: 'Grados y Secciones', icon: 'class', route: '/admin/academico', modulos: [MODULO.GRADOS_SECCIONES], exactMatch: true },
      { label: 'Catálogo de Cursos', icon: 'menu_book', route: '/admin/academico/cursos', modulos: [MODULO.GRADOS_SECCIONES], exactMatch: true },
      ...
      { label: 'Horario de Entrada', icon: 'schedule', route: '/admin/academico/horario-entrada', modulos: [MODULO.GRADOS_SECCIONES], exactMatch: true },
    ],
  },
  {
    label: 'Usuarios', icon: 'manage_accounts', modulos: [MODULO.USUARIOS],
    children: [
  ...
  },
  {
    ...
    route: '/admin/historico', modulos: [MODULO.HISTORICO_ALUMNOS], exactMatch: true,
  },
  {
    label: 'Reportes', icon: 'bar_chart',
    route: '/admin/reportes', modulos: [MODULO.REPORTES_GLOBALES], exactMatch: true,
  },
];