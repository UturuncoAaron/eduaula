export const MODULO = {
  ...
  REPORTES_ACCESO:   'reportes_acceso',    // docente/psicologa con permiso extra

  // ── Libretas padres
  // Admin: siempre en sus módulos base
  // Docente: inyectado en JWT cuando admin otorga libretas/subir_padre
